jQuery("#simulation")
  .on("click", ".s-4bb072ad-5fe4-4820-84f6-561915fc2321 .click", function(event, data) {
              ...
              "actions": [
                {
                  "action": "jimEnable",
                  "parameter": {
                    "target": [ "#s-Input_10","#s-Input_9","#s-Input_8","#s-Input_7" ]
                  },
                  "exectype": "serial",
                  "delay": 0
                }
              ...
              "actions": [
                {
                  ...
                  "parameter": {
                    "target": "screens/10132c0c-1598-424e-9c68-0ece5fd45caf",
                    "transition": {
                      "type": "slideup",
                      "duration": 700
                    }
  ...
  .on("dragend", ".s-4bb072ad-5fe4-4820-84f6-561915fc2321 .dragend", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
