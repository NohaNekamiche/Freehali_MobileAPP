jQuery("#simulation")
  .on("click", ".s-722c01a0-ae62-494b-9c78-471bf43cc848 .click", function(event, data) {
              ...
              "actions": [
                {
                  ...
                  "parameter": {
                    "target": "screens/aa44c35c-92cd-4d26-a02c-aaea17683e6c",
                    "transition": {
                      "type": "slideup",
                      "duration": 500
                    }
  ...
  .on("focusin", ".s-722c01a0-ae62-494b-9c78-471bf43cc848 .focusin", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
              ...
              "actions": [
                {
                  ...
                  "parameter": [ {
                    "#s-722c01a0-ae62-494b-9c78-471bf43cc848 #s-Input_9 input": {
                      "attributes": {
                        "color": "#999999"
                      }
                    }
  ...
  .on("focusout", ".s-722c01a0-ae62-494b-9c78-471bf43cc848 .focusout", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
              ...
              "actions": [
                {
                  "action": "jimChangeStyle",
                  "parameter": [ {
                    "#s-722c01a0-ae62-494b-9c78-471bf43cc848 #s-Input_9 .valign": {
                      "attributes": {
