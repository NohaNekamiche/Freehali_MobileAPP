jQuery("#simulation")
  .on("click", ".s-fe00d59f-d6b4-490e-9a97-8f454824b564 .click", function(event, data) {
              ...
              "actions": [
                {
                  ...
                  "parameter": {
                    "target": "screens/948cc35e-8942-4ec5-a3b2-aefb2b2baf4b",
                    "transition": {
                      "type": "slideleft",
                      "duration": 700
                    }
  ...
  .on("focusin", ".s-fe00d59f-d6b4-490e-9a97-8f454824b564 .focusin", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
              ...
              "actions": [
                {
                  ...
                  "parameter": [ {
                    "#s-fe00d59f-d6b4-490e-9a97-8f454824b564 #s-Input_9 input": {
                      "attributes": {
                        "color": "#999999"
                      }
                    }
  ...
  .on("focusout", ".s-fe00d59f-d6b4-490e-9a97-8f454824b564 .focusout", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
              ...
              "actions": [
                {
                  "action": "jimChangeStyle",
                  "parameter": [ {
                    "#s-fe00d59f-d6b4-490e-9a97-8f454824b564 #s-Input_9 .valign": {
                      "attributes": {
